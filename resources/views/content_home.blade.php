                    ...
                    <div class="row h-100 align-items-center justify-content-center">
                        <div class="col-12 col-lg-9">
                            <div class="welcome-text text-center">
                                ...
                                <a href="#" class="btn credit-btn mt-50 class_boton" data-animation="fadeInUp" data-delay="700ms" style="background-color: #ff8c00;">Empezar</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row h-100 align-items-center justify-content-center">
                        <div class="col-12 col-lg-9">
                            <div class="welcome-text text-center">
                                ...
                                <a href="#" class="btn credit-btn mt-50 class_boton" style="background-color: #ff8c00;" data-animation="fadeInDown" data-delay="700ms">Empezar</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row h-100 align-items-center justify-content-center">
                        <div class="col-12 col-lg-9">
                            <div class="welcome-text text-center">
                                ...
                                <p data-animation="fadeInUp" data-delay="500ms">Para comentar, debes ser un usuario registrado. ingresa o regístrate.</p>
                                <a href="#" class="btn credit-btn mt-50 class_boton" data-animation="fadeInUp" data-delay="700ms" style="background-color: #ff8c00;">Empezar</a>
                            </div>
                        </div>
                    </div>
