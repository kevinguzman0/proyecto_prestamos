<a href="#" data-toggle="modal" data-target="#eliminar-usuario-{{ $fila->id }}">
    <img src="{{ asset('icons/trash.svg') }}" alt="Eliminar usuario" width="24" height="24" title="Eliminar usuario" />
</a>
